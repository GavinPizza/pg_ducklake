...
SELECT ducklake.raw_query($$ ATTACH 'ducklake:/tmp/test_freeze.ducklake' AS __frozen__ $$);
RESET client_min_messages;

SELECT * FROM ducklake.query($$ SELECT * FROM __frozen__.public.freeze_test ORDER BY id $$);

SET client_min_messages = warning;
SELECT ducklake.raw_query($$ DETACH __frozen__ $$);
RESET client_min_messages;
...
SET client_min_messages = warning;
SELECT ducklake.raw_query($$ ATTACH 'ducklake:/tmp/test_freeze_inlined.ducklake' AS __frozen__ $$);
RESET client_min_messages;

SELECT * FROM ducklake.query($$ SELECT * FROM __frozen__.public.freeze_inlined ORDER BY a $$);
